...
*/
     ...
     * Пользователь положил в корзину несколько продуктов равной стоимости (несколько продуктов одного вида)
     * <br><b>Ожидаемый результат:</b>
     * Стоимость корзины посчиталась корректно
     */
    @Test
    ...
    void incorrectProductSelectionCausesException(int id) {
        assertThatThrownBy(() -> cart.addProductToCartByID(id))
                .isInstanceOf(RuntimeException.class).describedAs("Не найден продукт с id: " + id);
        // Assert (Проверка утверждения)
